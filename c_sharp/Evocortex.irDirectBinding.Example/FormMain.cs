...
namespace Evocortex.irDirectBinding.Example {
    public partial class FormMain : Form {
        ...
        IrDirectInterface _irDirectInterface2;
        ...
        private void FormMain_Load(object sender, EventArgs e) {
            ...
            _irDirectInterface2 = IrDirectInterface.Instance;
            _irDirectInterface2.Connect("generic2.xml");
        ...
        private void ImageGrabberMethode() {
            while (_grabImages) {
                ...
                ThermalPaletteImage images2 = _irDirectInterface2.GetThermalPaletteImage();
                ...
                this.BeginInvoke((MethodInvoker)(() => {
                    ...
                    _pbPaletteImage2.Image = images2.PaletteImage;
